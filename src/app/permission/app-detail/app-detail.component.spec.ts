...
import { ActivatedRouteSnapshot, ActivatedRoute, ParamMap, provideRouter } from '@angular/router'
...
describe('AppDetailComponent', () => {
  ...
  describe('create role', () => {
    ...
    it('should display error msg if create role fails', () => {
      ...
      expect(ev.stopPropagation).toHaveBeenCalled()
      expect(msgServiceSpy.error).toHaveBeenCalledWith({ summaryKey: 'ACTIONS.CREATE.MESSAGE.WORKSPACE_ROLES_NOK' })

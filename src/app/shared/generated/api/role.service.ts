...
export class RoleAPIService {
  ...
  public createRole(
    ...
    return this.httpClient.request<Array<Role>>(
      "post",
  ...
  public deleteRole(
    ...
    let localVarPath = `/roles/${this.configuration.encodeParam({
      name: "id",
      value: id,
      in: "path",
      style: "simple",
   ...
   */
  public getRoleById(
    requestParameters: GetRoleByIdRequestParams,
    observe?: "body",
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: "application/json"; context?: HttpContext }
  ): Observable<Role>;
  ...
  public getRoleById(
    ...
    return this.httpClient.request<Role>(
      "get",
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   */
  public searchRoles(
    requestParameters: SearchRolesRequestParams,
    observe?: "body",
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: "application/json"; context?: HttpContext }
  ): Observable<Array<RolePageResult>>;
  public searchRoles(
    requestParameters: SearchRolesRequestParams,
    observe?: "response",
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: "application/json"; context?: HttpContext }
  ): Observable<HttpResponse<Array<RolePageResult>>>;
  public searchRoles(
    requestParameters: SearchRolesRequestParams,
    observe?: "events",
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: "application/json"; context?: HttpContext }
  ): Observable<HttpEvent<Array<RolePageResult>>>;
  public searchRoles(
    requestParameters: SearchRolesRequestParams,
    observe: any = "body",
    reportProgress: boolean = false,
    ...
    if (roleSearchCriteria === null || roleSearchCriteria === undefined) {
      throw new Error(
        "Required parameter roleSearchCriteria was null or undefined when calling searchRoles."
      );
    }
    ...
    return this.httpClient.request<Array<RolePageResult>>(
      "post",
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,

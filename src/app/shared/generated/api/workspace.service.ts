...
export class WorkspaceAPIService {
   ...
   */
  public getAllProductsByWorkspaceName(
    requestParameters: GetAllProductsByWorkspaceNameRequestParams,
    observe?: "body",
  ...
  public getAllProductsByWorkspaceName(
    ...
    if (workspaceName === null || workspaceName === undefined) {
      throw new Error(
        "Required parameter workspaceName was null or undefined when calling getAllProductsByWorkspaceName."
      );
    }
    ...
    let localVarPath = `/workspaces/${this.configuration.encodeParam({
      name: "workspaceName",
      value: workspaceName,
      in: "path",
      style: "simple",

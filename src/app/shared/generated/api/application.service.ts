...
// @ts-ignore
import { ApplicationPageResult } from '../model/applicationPageResult';
// @ts-ignore
import { ApplicationSearchCriteria } from '../model/applicationSearchCriteria';
// @ts-ignore
...
export interface DeleteByApplicationNameRequestParams {
    name: string;
}
...
export class ApplicationAPIService {
     ...
     */
    public deleteByApplicationName(requestParameters: DeleteByApplicationNameRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any>;
    public deleteByApplicationName(requestParameters: DeleteByApplicationNameRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<any>>;
    public deleteByApplicationName(requestParameters: DeleteByApplicationNameRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<any>>;
    public deleteByApplicationName(requestParameters: DeleteByApplicationNameRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const name = requestParameters.name;
        if (name === null || name === undefined) {
            throw new Error('Required parameter name was null or undefined when calling deleteByApplicationName.');
        }
        ...
        let localVarPath = `/applications/${this.configuration.encodeParam({name: "name", value: name, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
    ...
    public searchApplications(requestParameters: SearchApplicationsRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (applicationSearchCriteria === null || applicationSearchCriteria === undefined) {
            throw new Error('Required parameter applicationSearchCriteria was null or undefined when calling searchApplications.');
        }
